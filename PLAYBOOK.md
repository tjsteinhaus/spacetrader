...
- [SpaceTraders Automation Playbook](#spacetraders-automation-playbook)
  ...
  - [Current Reset: TYLERDEVRUN / X1-BX78](#current-reset-tylerdevrun--x1-bx78)
    - [System Layout](#system-layout)
    - [Fuel Hop Chain: B7 → J62 (879 units)](#fuel-hop-chain-b7--j62-879-units)
    - [MEDICINE Contract (current)](#medicine-contract-current)
    - [Known Issues Fixed This Session](#known-issues-fixed-this-session)
    - [Jump Gate](#jump-gate)
